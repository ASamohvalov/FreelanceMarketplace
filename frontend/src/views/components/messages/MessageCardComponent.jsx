...
export default function MessageCardComponent({ message }) {
    ...
    return (
        <div className="position-relative">
            ...
            {show && (
                <div className={`position-absolute z-2 -bottom-10 bg-info gap-2 d-flex flex-column p-2 rounded-3 ${message.authorId === id ? "end-0" : "start-0"}`}>
                    <button className="btn btn-primary" onClick={() => {}}>Изменить</button>
