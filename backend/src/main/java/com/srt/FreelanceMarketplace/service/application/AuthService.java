...
public class AuthService {
    ...
    public JwtResponse signIn(SignInRequest request) {
        ...
        TokenEntity tokenEntity = TokenEntity.builder()
                ...
                .user(user)
                .build();
        tokenDomainService.save(tokenEntity);
    ...
    public void signUp(SignUpRequest request) {
        ...
        RoleEntity role = roleDomainService.getByName(RoleEnum.ROLE_USER);
        entity.setRoles(List.of(role));

        userDomainService.save(entity);
    }
    ...
    public JwtResponse updateTokens(JwtRequest request) {
        ...
        TokenEntity token = tokenDomainService.findByToken(request.getRefreshToken())
